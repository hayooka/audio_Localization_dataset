...
Model 2: 16 ms frame, seq=1 (single frame, no temporal context)
Train  : full 5-min recordings  (train_DATA16.csv)
Val    : first 1 min per angle  from 3-min recordings (test_DATA16.csv)
...
# ── Save model ────────────────────────────────────────────────────────────────
save_path = os.path.join(MODELS_DIR, 'audioLOC_CNN_m2.pt')
torch.save({
